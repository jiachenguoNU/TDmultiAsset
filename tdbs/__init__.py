...
high-level pricers:
    ...
    greeks_1d                           (1D first-order Greeks from the shape-gradient B)
    solve_basket_2d, price_at           (D=2 basket; off-grid price by FE reconstruction)
    greeks_at                           (D=2 basket first-order Greeks from the shape-gradient B)
...
references:
    bs_call, bs_greeks, bs_call_weighted, geo_basket_price, basket_cv_mc
"""
...
from .pricer_1d import solve_call_1d, interp_price, greeks_1d
from .pricer_2d import solve_basket_2d
from .evaluate import price_at, greeks_at
from .reference import bs_call, bs_greeks, bs_call_weighted, geo_basket_price, basket_cv_mc

__all__ = [
    "build_matrices_param", "nested_price_param", "basket_payoff_full", "basket_asymp_cp",
    "als_joint_op", "gpu_device_name", "cp_eval", "cp_rank", "cp_norm",
    "TD_solver_BS_sweep", "solve_call_1d", "interp_price", "greeks_1d",
    "solve_basket_2d", "price_at", "greeks_at",
    "bs_call", "bs_greeks", "bs_call_weighted", "geo_basket_price", "basket_cv_mc",
]
__version__ = "0.1.0"
